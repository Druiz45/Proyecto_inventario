                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3 col-sm-3  form-group has-feedback">
                                                ...
                                                <input type="text" class="form-control has-feedback-left" id="total" name="total" placeholder="Total" autocomplete="off" value="<?= $ordenCompra[0]['total'] ?>" readonly>
                                                <!-- <span class="fa fa-credit-card form-control-feedback left" aria-hidden="true"></span> -->
                                            </div>
                                            <div class="col-md-3 col-sm-3  form-group has-feedback">
                                                <label for="abono">Abono: </label>
                                                <input type="text" class="form-control has-feedback-left" id="abono" name="abono" placeholder="Abono" autocomplete="off" value="<?= $ordenCompra[0]['abono'] ?>" readonly>
                                                <!-- <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span> -->
                                            </div>
                                            <!-- <div class="col-md-3 col-sm-3  form-group has-feedback">
