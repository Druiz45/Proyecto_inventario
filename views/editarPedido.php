                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3 class="dark">Editar pedido</h3>
                        </div>
                    </div>
                    <div class="clearfix"></div>

                    <form class="form-label-left input_mask" id="form-update-pedido">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-md-10">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="form-group row align-items-center justify-content-center">
                                            <div class="col-md-4 col-sm-4  form-group has-feedback">
                                                ...
                                                <input type="text" class="form-control" id="nombreCliente" name="nombreCliente" placeholder="Nombre cliente" value="<?= $rows["nombre_cliente"] ?>" autocomplete="off" list="clientes">
                                                <!-- <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span> -->
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-1 col-sm-1  form-group has-feedback">
                                                        <div class="radio">
                                                            <label class="">
                                                                <div class="iradio_flat-green" style="position: relative;"><input type="radio" class="flat" id="iva" name="iva" <?= $rows["IVA"] == 1 ? "checked" : "" ?> value="1" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> Si
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1 col-sm-1  form-group has-feedback">
                                                        <div class="radio">
                                                            <label class="">
                                                                <div class="iradio_flat-green" style="position: relative;"><input type="radio" class="flat" id="iva" name="iva" <?= $rows["IVA"] == 0 ? "checked" : "" ?> value="0" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> No
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="form-group row align-items-center justify-content-end">
                                    <div class="col-md-3 col-sm-3  form-group has-feedback">
                                        <button type="submit" class="btn btn-primary btn-round" id="btn-editar-orden-compra"><i class="fa fa-arrow-down"></i> Editar pedido</button>
                                    </div>
                                </div>
