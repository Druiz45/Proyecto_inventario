        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <div class="">
                    ...
                    <form class="form-label-left input_mask" id="formCreateIngreso">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Nuevo ingreso<small>Informacion del ingreso</small></h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        <br />
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 col-sm-6  form-group has-feedback">
                                                <select class="select2_single form-control" id="tipoIngreso" name="tipoIngreso" tabindex="-1">
                                                    <option value="AK">Seleccione el tipo de ingreso</option>
                                                </select>
                                            </div>
                                        </div>
