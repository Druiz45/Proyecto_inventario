function updateEstado(cliente, updateMessage) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch(`/${url}/cliente/delete`, {
        method: "POST",
        body: formData
      })
        .then(respuesta => respuesta.json())
        .then(data => {
          if (data == `El cliente se ${message} correctamente`) {
            Swal.fire({
              icon: 'success',
              title: data,
              // text: data,
